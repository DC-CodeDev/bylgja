...
function resetFlipInlineStyles(element: HTMLElement): void {
  element.style.transform = "none";
...
export function startFlipInvert(
  element: HTMLElement,
  from: FlipInvertMeasurement,
  to: FlipInvertMeasurement,
  options?: FlipInvertOptions,
): FlipInvertAnimation {
